...
nFactorial(n) debe retornar el factorial de n sabiendo que, siendo n un número natural, 
 factorial (representado como n!) es el producto de n por todos los números naturales menores que él y 
...
function nFactorial(n) {
  ...
  if(n === 0 || n === 1) return 1;
  //validar
  if(n < 0) return 'No se puede fac un neg!!!'
  if(n % 1 !== 0) return 'Solo num enteros!!!'
  // recursion
